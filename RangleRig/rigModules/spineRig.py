...
class spineGen(): 
    ...
    def __init__(self, basejoint, ikSegments, fkSegments,characterName, rigGrp, visGrp):
        ...
        jnt2 = mc.rename(rigJnts[01], ID + '_02_Jnt')
        ...
        ikBack = jntSegmenter.jointSegment(jnt1, noJoints  , 'ik'+ID)
        ...
        #Segments
        noJoints = fkSegments
        fkBack = jntSegmenter.jointSegment(fkHips, noJoints  , 'fk'+ ID)
        ...
        #Set up
        mc.parent(self.hipJnt,self.ctrlHip)
        ...
        mc.parent(self.chestJnt,self.ctrlChest)
