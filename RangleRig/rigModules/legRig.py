...
class legGen():
    ...
    def __init__ (self, basejoint, characterName, rigGrp, settingsGrp, visGrp):
        ...
        locX = mc.getAttr(basejoint + ".translateX")
        print basejoint
        ...
        baseGrp = mc.group(jnt1, name = prefix + 'LegBase_grp')
        print baseGrp
       ...
       #Clean Up (Non Joint)
        ...
        #Create Vis Control
        mc.select(visGrp)
        mc.addAttr( shortName=ID + '_LegVis', longName=ID + '_LegVis', attributeType = 'enum', enumName = 'FK:IK:Both:None' , keyable = True, hidden = False )
        
        #Set Visibility Keys Left Legs
        for i in fkCon:
            setDvrKey.setDvrK(visGrp +  '.' + ID + '_LegVis', i + 'Shape.visibility', 0, 1)
            setDvrKey.setDvrK(visGrp +  '.' + ID + '_LegVis', i + 'Shape.visibility', 1, 0)
            setDvrKey.setDvrK(visGrp +  '.' + ID + '_LegVis', i + 'Shape.visibility', 2, 1)
            setDvrKey.setDvrK(visGrp +  '.' + ID + '_LegVis', i + 'Shape.visibility', 3, 0)
        
        for i in ikCon:
            setDvrKey.setDvrK(visGrp +  '.' + ID + '_LegVis', i + '.visibility', 0, 0)
            setDvrKey.setDvrK(visGrp +  '.' + ID + '_LegVis', i + '.visibility', 1, 1)
            setDvrKey.setDvrK(visGrp +  '.' + ID + '_LegVis', i + '.visibility', 2, 1)
            setDvrKey.setDvrK(visGrp +  '.' + ID + '_LegVis', i + '.visibility', 3, 0)
